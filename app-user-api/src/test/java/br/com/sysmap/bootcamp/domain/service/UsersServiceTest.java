...
public class UsersServiceTest {
    ...
    public void createShouldThrowExceptionWhenInValidUsers() {
        ...
        when(passwordEncoder.encode(any())).thenReturn("encodedMockpassword");
        assertThrows(NoSuchElementException.class, () -> usersService.create(new UserRequestDto(invalidUsers), walletService));
    }
    ...
    public void updateShouldThrowExceptionWhenInValidUsers() {
        ...
        assertThrows(NoSuchElementException.class, () -> usersService.update(userUpdateRequestDto));
    }
